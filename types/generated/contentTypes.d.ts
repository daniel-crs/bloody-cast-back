...
export interface ApiBloodyCastInfoBloodyCastInfo extends Schema.CollectionType {
  collectionName: 'bloody_cast_infos';
  info: {
    singularName: 'bloody-cast-info';
    pluralName: 'bloody-cast-infos';
    displayName: 'bloodyCastInfo';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::bloody-cast-info.bloody-cast-info',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFilmeFilme extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tag: Attribute.String & Attribute.Required & Attribute.DefaultTo<'filmes'>;
    title: Attribute.String & Attribute.Required;
    description: Attribute.Text & Attribute.Required;
...
export interface ApiMusicaMusica extends Schema.CollectionType {
  collectionName: 'musicas';
  info: {
    singularName: 'musica';
    pluralName: 'musicas';
    displayName: 'musica';
...
export interface ApiPodcastPodcast extends Schema.CollectionType {
  ...
  attributes: {
    ...
    participants: Attribute.Relation<
      ...
      'api::participant.participant'
    >;
    tag: Attribute.String & Attribute.Required & Attribute.DefaultTo<'podcast'>;
    date: Attribute.Date & Attribute.Required;
    destaque: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
...
export interface ApiWellcomeBannerWellcomeBanner extends Schema.CollectionType {
  collectionName: 'wellcome_banners';
  info: {
    singularName: 'wellcome-banner';
    pluralName: 'wellcome-banners';
    displayName: 'WellcomeBanner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::wellcome-banner.wellcome-banner',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::wellcome-banner.wellcome-banner': ApiWellcomeBannerWellcomeBanner;
    }
  }
}
